...
export function RadioGroupItem(props: RadioGroupPrimitive.RadioGroupItemProps) {
  return (
    <RadioGroupPrimitive.RadioGroupItem
      {...props}
      className="group bg-black border border-zinc-900 rounded-lg px-4 py-2.5 flex items-center justify-between outline-none hover:border-zinc-800 focus-visible:border-green-500 focus-visible:ring-4 ring-pink-500/10 data-[state=checked]:bg-green -500/5 data-[state=checked]:border-green-500"
    />
  )
}
